const AuditLogs = ({logs, page=1, totalPages, onPageChange:setPage}) => {
        ...
        <table className="w-full border-collapse border">
          <thead className="bg-[#F5F5F5] text-[#666666]">
            <tr className="text-left">
              ...
              <th className="p-4 border-t border-l border-r border-[#EBEBEB] font-semibold text-base">Actions</th>
              ...
              <tr key={idx} className="border-b">
                <td className="p-5 border-b border-l border-r border-[#F5F5F5] font-semibold text-base text-[#2E2E2E] truncate">
                  <div className="flex w-full items-center gap-1">
                    <span className="max-w-[80%] truncate">ADMIN-{l.adminId}</span>
