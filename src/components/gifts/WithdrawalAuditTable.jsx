const WithdrawalAuditTable = ({logs, page=1, totalPages, onPageChange:setPage}) => {
            ...
            {logs.map((l, idx) => (
              <tr key={idx} className="border-b">
                ...
                <td className="p-5 border-b border-l border-r border-[#F5F5F5] font-semibold text-base text-[#2E2E2E]">
                  <div className="flex">
                    <span className="max-w-72 truncate">{l.reason}</span>
                  </div>
                </td>
...
export default WithdrawalAuditTable
