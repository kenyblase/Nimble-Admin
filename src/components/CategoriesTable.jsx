...
const CategoriesTable = ({categories=[], page=1, totalPages, setPage, search, setSearch}) => {
        ...
        {categories.length > 0 ? (
            <div>
                ...
                <thead className="bg-[#E9F1FF] text-[#1C5ECA]">
                    ...
                    <th className="p-4 border-t border-l border-r border-[#EBEBEB] font-semibold text-base">Parent category</th>
                    <th className="p-4 border-t border-l border-r border-[#EBEBEB] font-semibold text-base">Commission</th>
                    <th className="p-4 border-t border-l border-r border-[#EBEBEB] font-semibold text-base">Listed items</th>
                ...
                <tbody>
                    ...
                    <tr key={cat._id} className="border-b">
                        <td className="p-5 border-b border-l border-r border-[#F5F5F5] font-normal text-sm text-[#071832]">{cat.name}</td>
                        <td className="p-5 border-b border-l border-r border-[#F5F5F5] font-normal text-sm text-[#071832]">{cat?.parentCategory?.name || 'N/A'}</td>
                        <td className="p-5 border-b border-l border-r border-[#F5F5F5] font-normal text-sm text-[#071832]">{cat.commissionPercentage}</td>
                        <td className="p-5 border-b border-l border-r border-[#F5F5F5] font-normal text-sm text-[#071832]">{cat.listedItems}</td>
            ...
            </div>) : <p className='text-center'>No Categories Found</p>}
        </>
    </div>
  )
}
