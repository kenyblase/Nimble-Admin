...
const DisputeTable = ({requests, page=1, totalPages, onPageChange:setPage}) => {
        ...
        <table className="w-full border-collapse border">
          <thead className="bg-[#0057FF] text-white">
            <tr className="text-left">
              <th className="p-4 border-t border-l border-r border-[#EBEBEB] font-semibold text-base">Dispute ID</th>
              <th className="p-4 border-t border-l border-r border-[#EBEBEB] font-semibold text-base">Request ID</th>
              <th className="p-4 border-t border-l border-r border-[#EBEBEB] font-semibold text-base">Complainant</th>
              <th className="p-3 border-t border-l border-r border-[#EBEBEB] font-semibold text-base">Reason</th>
