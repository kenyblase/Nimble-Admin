...
import WithdrawalTable from '../../components/gifts/WithdrawalTable';
import { Filter } from 'lucide-react';
import WithdrawalAuditTable from '../../components/gifts/WithdrawalAuditTable';
...
const Gifts = () => {
  ...
  const mockWithdrawals = [
    { id: "USER10235", name: "Lilian White", amount: 2000, accountNumber: "09032637463", bankName: 'Opay', requestDate: "02/07/2025", status: "Approved", verification: "Verified" },
    { id: "USER10235", name: "Lilian White", amount: 2000, accountNumber: "09032637463", bankName: 'Opay', requestDate: "02/07/2025", status: "Pending", verification: "Unverified" },
    { id: "USER10235", name: "Lilian White", amount: 2000, accountNumber: "09032637463", bankName: 'Opay', requestDate: "02/07/2025", status: "Rejected", verification: "Verified" },
  ];

  const mockAudits = [
    { adminId: 'ADMIN001', requestId: "RQID10235", userId: "USER10235", report: "Inappropriate Post", action: "Approved", reason: 'Withdrawal processed', date: "02/07/2025" },
    { adminId: 'ADMIN002', requestId: "RQID10236", userId: "USER10236", report: "Inappropriate Post", action: "Rejected", reason: 'Invalid Bank Details', date: "02/07/2025" }
  ]
  return (
    <div className='h-full'>
      <div className='flex justify-between'>
        <Header
          text={'Gift Withdrawal'}
        />
        <HeaderButtons
          icon={icons.calendar}
      ...
      <div className="py-3">
        <div className='flex justify-between items-center'>
          <TableHeader title={'Withdrawal Request Table'} isFiltering={false}/>
